            ...
            itemBuilder: (context, index) {
              ...
              if (productData is Map<String, dynamic>) {
                ...
                if (productData['ROM'] != null && productData['ROM'] is List<dynamic>) {
                  ...
                  romString = rom.join(', '); // Join the elements of the list into a single string
                }
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(child: Padding(
                        ...
                        child: Image.network(productImage,height: 120.h,),
                      )),
                      ...
                      //   child: Text('Color: $color',  style: TextStyle(
                      //       fontSize: 15
                      //   )),
                      // ),
                      Padding(
                        padding: const EdgeInsets.only(left: 8.0),
                        child: Text('ROM: $romString GB',style: TextStyle(
                    fontSize: 15
                )),
                      ),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left:  8.0),
                        child: Text('Price: Rs ${price.toStringAsFixed(2)}',  style: TextStyle(
